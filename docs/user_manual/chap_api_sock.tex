...
\item \texttt{remote$\_$port} - Portnumber of the sender socket (pointer)
\end{itemize}
...
\item \texttt{PICO$\_$IP$\_$MULTICAST$\_$IF} - 
\item \texttt{PICO$\_$IP$\_$MULTICAST$\_$TTL} - 
\item \texttt{PICO$\_$IP$\_$MULTICAST$\_$LOOP} - 
\item \texttt{PICO$\_$IP$\_$ADD$\_$MEMBERSHIP} - 
\item \texttt{PICO$\_$IP$\_$DROP$\_$MEMBERSHIP} -
\end{itemize}
