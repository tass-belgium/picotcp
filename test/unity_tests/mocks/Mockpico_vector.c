...
static struct Mockpico_vectorInstance
{
  ...
  int pico_vector_pop_back_IgnoreBool;
  void* pico_vector_pop_back_FinalReturn;
  CMOCK_pico_vector_pop_back_CALLBACK pico_vector_pop_back_CallbackFunctionPointer;
  int pico_vector_pop_back_CallbackCalls;
...
void Mockpico_vector_Verify(void)
{
  ...
  if (Mock.pico_vector_push_back_CallbackFunctionPointer != NULL)
    Mock.pico_vector_push_back_CallInstance = CMOCK_GUTS_NONE;
  if (Mock.pico_vector_pop_back_IgnoreBool)
    Mock.pico_vector_pop_back_CallInstance = CMOCK_GUTS_NONE;
  ...
  if (Mock.pico_vector_pop_back_CallbackFunctionPointer != NULL)
    Mock.pico_vector_pop_back_CallInstance = CMOCK_GUTS_NONE;
...
void Mockpico_vector_Destroy(void)
{
  ...
  Mock.pico_vector_pop_back_CallbackFunctionPointer = NULL;
  Mock.pico_vector_pop_back_CallbackCalls = 0;
...
void* pico_vector_pop_back(struct pico_vector* vector)
{
  ...
  {
    if (cmock_call_instance == NULL)
      return Mock.pico_vector_pop_back_FinalReturn;
    Mock.pico_vector_pop_back_FinalReturn = cmock_call_instance->ReturnVal;
    return cmock_call_instance->ReturnVal;
  }
  if (Mock.pico_vector_pop_back_CallbackFunctionPointer != NULL)
  {
    return Mock.pico_vector_pop_back_CallbackFunctionPointer(vector, Mock.pico_vector_pop_back_CallbackCalls++);
  }
...
void pico_vector_pop_back_CMockIgnoreAndReturn(UNITY_LINE_TYPE cmock_line, void* cmock_to_return)
{
  ...
  cmock_call_instance->LineNumber = cmock_line;
  cmock_call_instance->ReturnVal = cmock_to_return;
  Mock.pico_vector_pop_back_IgnoreBool = (int)1;
}
...
{
  Mock.pico_vector_pop_back_CallbackFunctionPointer = Callback;
}
