...
struct zmtp_socket* zmtp_socket_open(uint16_t net, uint16_t proto, uint8_t type, void* parent, cmock_pico_zmtp_func_ptr1 zmq_cb)
{
  UNITY_LINE_TYPE cmock_line = TEST_LINE_NUM;
  ...
  {
    UNITY_TEST_ASSERT_EQUAL_PTR(cmock_call_instance->Expected_parent, parent, cmock_line, "Function 'zmtp_socket_open' called with unexpected value for argument 'parent'.");
  }
  {
...
void CMockExpectParameters_zmtp_socket_open(CMOCK_zmtp_socket_open_CALL_INSTANCE* cmock_call_instance, uint16_t net, uint16_t proto, uint8_t type, void* parent, cmock_pico_zmtp_func_ptr1 zmq_cb)
{
  cmock_call_instance->Expected_net = net;
  cmock_call_instance->Expected_proto = proto;
  cmock_call_instance->Expected_type = type;
  cmock_call_instance->Expected_parent = parent;
...
void zmtp_socket_open_CMockExpectAndReturn(UNITY_LINE_TYPE cmock_line, uint16_t net, uint16_t proto, uint8_t type, void* parent, cmock_pico_zmtp_func_ptr1 zmq_cb, struct zmtp_socket* cmock_to_return)
{
  ...
  Mock.zmtp_socket_open_CallInstance = CMock_Guts_MemChain(Mock.zmtp_socket_open_CallInstance, cmock_guts_index);
  cmock_call_instance->LineNumber = cmock_line;
  CMockExpectParameters_zmtp_socket_open(cmock_call_instance, net, proto, type, parent, zmq_cb);
  cmock_call_instance->ReturnVal = cmock_to_return;
}
