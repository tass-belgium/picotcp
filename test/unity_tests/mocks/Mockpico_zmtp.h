...
#define zmtp_socket_open_ExpectAndReturn(net, proto, zmq_cb, cmock_retval) zmtp_socket_open_CMockExpectAndReturn(__LINE__, net, proto, zmq_cb, cmock_retval)
...
typedef struct zmtp_socket* (* CMOCK_zmtp_socket_open_CALLBACK)(uint16_t net, uint16_t proto, cmock_pico_zmtp_func_ptr1 zmq_cb, int cmock_num_calls);
