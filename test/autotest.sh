...
echo "UDP TEST"
(./build/test/picoapp.elf --vde pic0:/tmp/pic0.ctl:10.40.0.8:255.255.0.0: -a udpecho:10.40.0.8:6667 >/dev/null) &
./build/test/picoapp.elf --vde pic0:/tmp/pic0.ctl:10.40.0.9:255.255.0.0: -a udpclient:10.40.0.8:6667:1400:100:10 >/dev/null || exit 1
wait || exit 1
wait
...
echo "NAT UDP TEST"
(./build/test/picoapp.elf --vde pic0:/tmp/pic0.ctl:10.40.0.10:255.255.0.0: --vde pic1:/tmp/pic1.ctl:10.50.0.10:255.255.0.0: -a natbox:10.50.0.10) &
(./build/test/picoapp.elf --vde pic0:/tmp/pic1.ctl:10.50.0.8:255.255.0.0: -a udpecho:10.50.0.8:6667 >/dev/null) &
...
echo "DHCP DUAL TEST"
(./build/test/picoapp.elf --vde pic0:/tmp/pic0.ctl:10.40.0.1:255.255.0.0: -a dhcpserver:pic0:10.40.0.1:255.255.255.0) &
(./build/test/picoapp.elf --vde pic1:/tmp/pic1.ctl:10.50.0.1:255.255.0.0: -a dhcpserver:pic1:10.50.0.1:255.255.255.0) &
