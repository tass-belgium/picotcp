...
./build/test/picoapp.elf --vde pic0:/tmp/pic0.ctl:10.40.0.9:255.255.0.0: -a udpclient:10.40.0.8:6667:1400:100:10: || exit 1
wait || exit 1
wait
...
./build/test/picoapp.elf --vde pic0:/tmp/pic0.ctl:10.40.0.9:255.255.0.0:10.40.0.10: -a udpclient:10.50.0.8:6667:1400:100:10 || exit 1
...
sleep 2
./build/test/picoapp.elf --vde pic0:/tmp/pic0.ctl:10.40.0.2:255.255.0.0: -a mcastsend:10.40.0.2:224.7.7.7:6667 || exit 1
(wait && wait && wait) || exit 1

killall picoapp.elf

echo "DHCP TEST"
(./build/test/picoapp.elf --vde pic0:/tmp/pic0.ctl:10.40.0.1:255.255.0.0: -a dhcpserver:pic0:10.40.0.1:255.255.255.0:10.40.0.40:10.40.0.140:) &
./build/test/picoapp.elf --barevde pic0:/tmp/pic0.ctl: -a dhcpclient:pic0 || exit 1
killall picoapp.elf

echo "DHCP DUAL TEST"
(./build/test/picoapp.elf --vde pic0:/tmp/pic0.ctl:10.40.0.1:255.255.0.0: -a dhcpserver:pic0:10.40.0.1:255.255.255.0:10.40.0.40:10.40.0.140:) &
(./build/test/picoapp.elf --vde pic1:/tmp/pic1.ctl:10.50.0.1:255.255.0.0: -a dhcpserver:pic1:10.50.0.1:255.255.255.0:10.50.0.50:10.50.0.150:) &
./build/test/picoapp.elf --barevde pic0:/tmp/pic0.ctl: --barevde pic1:/tmp/pic1.ctl: -a dhcpdualclient:pic0:pic1 || exit 1
killall picoapp.elf
