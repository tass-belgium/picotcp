...
uint32_t pico_timer_add(pico_time expire, void (*timer)(pico_time, void *),
                        void *arg);
uint32_t pico_timer_add_hashed(pico_time expire,
                               void (*timer)(pico_time, void *), void *arg,
                               uint32_t hash);
uint32_t pico_timers_size(void);
uint64_t pico_timers_populate_timer_fds(int id_expiry_fd[]);
