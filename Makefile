...
units: mod core lib $(UNITS_OBJ) $(MOD_OBJ)
	...
	@$(CC) -o $(PREFIX)/test/modunit_802154.elf $(CFLAGS) -I. test/unit/modunit_pico_802154.c  -lcheck -lm -pthread -lrt $(UNITS_OBJ) $(PREFIX)/lib/libpicotcp.a
	@$(CC) -o $(PREFIX)/test/modunit_6lowpan.elf $(CFLAGS) -I. -I test/examples test/unit/modunit_pico_6lowpan.c  -lcheck -lm -pthread -lrt -lpcap $(UNITS_OBJ) $(PREFIX)/lib/libpicotcp.a
