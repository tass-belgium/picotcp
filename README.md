...
[![Jenkins autotest](http://jenkins.picotcp.com:8080/buildStatus/icon?job=picoTCP_Dev/PicoTCP_rel_autotest)](http://jenkins.picotcp.com:8080/job/picoTCP_Dev/PicoTCP_rel_autotest)

Jenkins Unit tests      : 
[![Jenkins unit tests](http://jenkins.picotcp.com:8080/buildStatus/icon?job=picoTCP_Dev/PicoTCP_rel_unit_tests)](http://jenkins.picotcp.com:8080/job/picoTCP_Dev/PicoTCP_rel_unit_tests)

Jenkins RFC compliance  :
[![Jenkins RFC Compliance](http://jenkins.picotcp.com:8080/buildStatus/icon?job=picoTCP_Dev/PicoTCP_rel_RF_mbed)](http://jenkins.picotcp.com:8080/job/picoTCP_Dev/PicoTCP_rel_RF_mbed)

Jenkins TICS quality    :
[![Jenkins TICS](http://jenkins.picotcp.com:8080/buildStatus/icon?job=picoTCP_Dev/PicoTCP_rel_TICS)](http://jenkins.picotcp.com:8080/job/picoTCP_Dev/PicoTCP_rel_TICS/)
